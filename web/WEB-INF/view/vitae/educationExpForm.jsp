...
<div class="container" style="width: 500px; margin-top: 10px;">
	<div class="row">
		<div class="col-xs-12 col-md-12 col-sm-12">
			<form id="educationExpForm" class="form-horizontal" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
				...
				<div class="form-group">
					<label for="educationExpForm" class="col-xs-3 col-md-3 col-sm-2 control-label">学校/培训机构名称</label>
					<div class="col-xs-9 col-md-9 col-sm-8">
						<input type="text" name="schoolName" class="form-control" placeholder="请输入学校/培训机构名称" required autofocus>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="educationExpForm" class="col-xs-3 col-md-3 col-sm-2 control-label">学习/培训内容</label>
					<div class="col-xs-9 col-md-9 col-sm-8">
						<textarea class="form-control" name="info" rows="3" placeholder="请输入学习/培训内容" required></textarea>
					</div>
				</div>
			</form>
		</div>
...
$(function() {
	$('#educationExpForm').bootstrapValidator();
})
</script>