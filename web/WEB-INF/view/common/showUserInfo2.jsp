		...
		<div class="col-xs-12 col-md-12 col-sm-12">
			<form id="userInfoForm" class="form-horizontal">
				...
				<div class="form-group">
					<label for="userInfoForm" class="col-xs-3 col-md-3 col-sm-2 control-label">企业名称</label>
					<div class="col-xs-9 col-md-9 col-sm-8">
						<input type="text" name="name" class="form-control" placeholder="请输入企业名称">
					</div>
				</div>
				<div class="form-group">
					<label for="userInfoForm" class="col-xs-3 col-md-3 col-sm-2 control-label">企业类型</label>
					<div class="col-xs-9 col-md-9 col-sm-8">
						<div fieldset="type">
				...
				<div class="form-group">
					<label for="userInfoForm" class="col-xs-3 col-md-3 col-sm-2 control-label">企业地址</label>
					<div class="col-xs-9 col-md-9 col-sm-8">
						<input type="text" name="enterpriseAdd" onclick="areaTree(this)" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="userInfoForm" class="col-xs-3 col-md-3 col-sm-2 control-label">企业简介</label>
					<div class="col-xs-9 col-md-9 col-sm-8">
